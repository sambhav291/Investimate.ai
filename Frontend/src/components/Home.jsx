...
//   return (
//     <div ref={vantaRef} className="min-h-screen  flex items-center justify-center text-white">
//       <h1 className="text-4xl font-bold text-center">Welcome to investiMate</h1>
//     </div>
//   );
// };
