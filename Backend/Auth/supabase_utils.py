...
# #     with open(local_path, "rb") as f:
# #         try:
# #             supabase.storage.from_(SUPABASE_BUCKET).upload(dest_path, f)
# #         except Exception as e:
...
#         try:
#             supabase.storage.from_(SUPABASE_BUCKET).upload(dest_path, f)
#             print(f"[Supabase] Uploaded file: {dest_path}")
#         except Exception as e:
#             print(f"[ERROR] Supabase upload error: {e}")
#             return None
#     return dest_path
...
#     try:
#         res = supabase.storage.from_(SUPABASE_BUCKET).create_signed_url(dest_path, expires_in)
#         print(f"[Supabase] Created signed URL for {dest_path}: {res['signedURL']}")
#         return res['signedURL']
#     except Exception as e:
#         print(f"[ERROR] Failed to create signed URL: {e}")
#         return None