    ...
    def generate_cover_page(self, key_metrics):
        ...
        <div class="cover-page">
            ...
            <div class="brand-section">
                <div class="brand-logo"><img src="https://investimate-ai-eight.vercel.app/Investimate%20logo.png" alt="Investimate" class="brand-img"/></div>
    ...
    def get_report_css(self):
        ...
        * {
        ...
        .cover-page {
            ...
            background: linear-gradient(135deg, #202c60 0%, #664588 100%);
            color: white;
            padding: 1rem;
            min-height: 800px;
            max-height: 1200px;
