// OPTIMIZED Bicep template for Investimate Backend deployment
// B1 Basic tier - Cost: ~$13.14/month (optimized for production)
...
resource appServicePlan 'Microsoft.Web/serverfarms@2024-04-01' = {
  ...
  tags: tags
  sku: {
    name: 'B1'      // Basic tier - $13.14/month
    tier: 'Basic'
    capacity: 1
  }
  kind: 'linux'
...
resource appService 'Microsoft.Web/sites@2024-04-01' = {
  ...
  properties: {
    ...
    siteConfig: {
      ...
      alwaysOn: true  // Available on B1 tier - keeps app warm
      httpLoggingEnabled: true  // Enable logging for debugging
      ftpsState: 'Disabled'
      minTlsVersion: '1.2'
