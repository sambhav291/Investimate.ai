...
def enhance_annual_data(basic_annual_data, stock_name):
    ...
    {{
        ...
        "balance_sheet_strength": {{
            ...
            "working_capital_analysis": ["inventory turnover, receivables, payables cycles"]
        }},
        "cash_flow_analysis": {{
        ...
        "strategic_initiatives": {{
            ...
            "sustainability_initiatives": ["ESG investments and commitments"],
            "merger_acquisition_activity": ["M&A strategy and recent deals"]
        }},
        "risk_disclosures": {{
        ...
        "valuation_metrics": {{
            ...
            "enterprise_value_metrics": ["EV/EBITDA, EV/Sales calculations"],
        ...
        "management_discussion": {{
            ...
            "critical_accounting_policies": ["important accounting methods"],
